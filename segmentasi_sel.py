...
blur_g = cv2.GaussianBlur(gray, (9, 9), 2)
...
contrast_stretched = pixel_val_vec(gray, r1, s1, r2, s2)
...
circles = cv2.HoughCircles(blur_g, cv2.HOUGH_GRADIENT, 1.2, 20,
...
images = [image, gray, blur_m, blur_g,
          histo_norm, clahe_norm, contrast_stretched, edge,
...
# Show original and detected circles side by side
